...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Chat web application."
  #
  #
  ...
  #
  # settings.secret_key_base= PqrsI5oaPXph66O2clEv1XLp2JhGh46gJ1FRexo79Ow
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("chat.log", "w"))
  #
  #
end
